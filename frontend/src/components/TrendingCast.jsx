...
export default function TrendingCast(){
    ...
    return(
<div className="p-4 mt-10 bg-gradient-to-br from-[#141414] via-[#0f0f0f] to-[#1a1a1a] mx-5 w-2/5 rounded-2xl h-auto border border-[#2a2a2a]">
  ...
  <div className="relative mt-4">
   ...
   :
    ...
    <div
    className="flex flex-col space-y-4 max-h-[560px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900 pr-2 scrollbar-hidden"
  >
