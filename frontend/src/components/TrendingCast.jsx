...
export default function TrendingCast(){
    ...
    return(
<div className="md:p-4 p-2 md:mt-10 mt-2 mb-4 bg-gradient-to-br from-[#141414] via-[#0f0f0f] to-[#1a1a1a] mx-4 md:mx-10 lg:w-2/3 max-w-screen rounded-2xl h-auto border border-[#2a2a2a]">
  ...
  <div className="relative mt-4">
   ...
   :
    ...
    <div
    className="flex flex-col items-center space-y-4 max-h-[560px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900 pr-2 scrollbar-hidden"
  >
